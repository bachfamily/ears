...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 129.0, 77.0, 22.0 ],
					"text" : "absolutepath"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3.0, 445.0, 164.0, 104.0 ],
					"text" : "WAV 5.1 order is usually:\n1) Front Left, \n2) Front Right, \n3) Center,\n4) Low-frequency effects, \n5) Surround Left, \n6) Surround Right"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 107.0, 68.0, 22.0 ],
					"text" : "earstest5.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 176.0, 487.5, 105.0, 22.0 ],
					"text" : "$2 $5 $1 $3 $4 $6"
				}
...
, 			{
				"box" : 				{
					"code" : "if $l1.length() < 6 then ( print( \"Not enough audio channels for files:\" ); print($l1)) else $l1 ",
					"id" : "obj-30",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 176.0, 415.0, 531.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 1,
						"versionnumber" : 80103
					}
,
					"text" : "bach.eval if $l1.length() < 6 then ( print( \"Not enough audio channels for files:\" )\\; print($l1)) else $l1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 176.0, 529.5, 68.0, 22.0 ],
					"text" : "ears.pack~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 176.0, 376.0, 58.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80103
					}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 513.0, 44.0, 64.0, 47.0 ],
					"text" : "L = left\nC = center\nR = right"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 390.0, 336.0, 90.0, 24.0 ],
					"text" : "Then iterate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 176.0, 336.0, 198.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80103
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 229.5, 290.0, 144.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80103
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 330.0, 256.0, 117.0, 22.0 ],
					"text" : "regexp .+/(.+)\\\\..*\\\\..*"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 205.0, 256.0, 117.0, 22.0 ],
					"text" : "regexp .+/(.+)\\\\..*\\\\..*"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 176.0, 223.0, 129.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 1,
						"versionnumber" : 80103
					}
,
					"text" : "bach.classify @out nm"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 176.0, 192.0, 58.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80103
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 20.0, 157.0, 175.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 362.0, 111.0, 164.0, 24.0 ],
					"text" : "...or drop your folder here!"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 330.0, 103.5, 33.0, 42.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 1 ],
					"midpoints" : [ 239.0, 321.0, 459.0, 321.0, 459.0, 215.0, 295.5, 215.0 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 339.5, 152.75, 29.5, 152.75 ],
					"source" : [ "obj-8", 0 ]
				}
