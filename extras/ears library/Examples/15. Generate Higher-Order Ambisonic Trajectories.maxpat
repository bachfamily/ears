...
, 			{
				"box" : 				{
					...
					"text" : "We generate 5 trajectories"
				}
...
, 			{
				"box" : 				{
					"code" : "[for $i in arithmser(0,1,0.5) collect [$i random(0, 360)/100.]] ",
					"id" : "obj-24",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
...
,
					"text" : "bach.eval [for $i in arithmser(0\\,1\\,0.5) collect [$i random(0\\, 360)/100.]]"
				}

			}
, 			{
				"box" : 				{
					"code" : "[for $i in arithmser(0,1,0.5) collect [$i random(0., 157)/100.]] ",
					"id" : "obj-23",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
...
,
					"text" : "bach.eval [for $i in arithmser(0\\,1\\,0.5) collect [$i random(0.\\, 157)/100.]]"
				}

			}
, 			{
				"box" : 				{
					"code" : "[for $i in arithmser(0,1,0.2) collect [$i random(50, 200)/100.]] ",
					"id" : "obj-17",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
...
,
					"text" : "bach.eval [for $i in arithmser(0\\,1\\,0.2) collect [$i random(50\\, 200)/100.]]"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 90.0, 148.0, 40.0, 22.0 ],
					"text" : "uzi 5"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 110.0, 175.0, 55.5, 175.0 ],
					"source" : [ "obj-12", 1 ]
				}
