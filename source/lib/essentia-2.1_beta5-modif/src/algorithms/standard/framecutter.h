...
class FrameCutter : public Algorithm {
 ...
 protected:
  ...
  Real _startIndexReal; // a real-valued version of the start index, useful with non-integer hopsize
  int _frameSize;
  bool _lastFrame;
 ...
 public:
  ...
  void declareParameters() {
    ...
    declareParameter("hopSize", "the hop size between frames", "(0,inf)", 512.);
...
class FrameCutter : public Algorithm {
 ...
 public:
  ...
  void declareParameters() {
    ...
    declareParameter("hopSize", "the number of samples to jump after a frame is output", "(0,inf)", 512.);
