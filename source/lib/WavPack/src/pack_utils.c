...
static int create_riff_header (WavpackContext *wpc, int64_t total_samples, void *outbuffer)
{
    ...
    if (write_junk) {
        ...
        WavpackNativeToLittleEndian (&junkchunk, WPChunkHeaderFormat);
    }
    ...
    if (do_rf64) {
        ...
        WavpackNativeToLittleEndian (&ds64hdr, WPChunkHeaderFormat);
    ...
    WavpackNativeToLittleEndian (&riffhdr, WPChunkHeaderFormat);
    WavpackNativeToLittleEndian (&fmthdr, WPChunkHeaderFormat);
    WavpackNativeToLittleEndian (&wavhdr, WaveHeaderFormat);
    WavpackNativeToLittleEndian (&datahdr, WPChunkHeaderFormat);
