...
typedef struct s_AIFFCommon AIFF_CommonChunk ;
...
typedef struct s_Marker AIFF_Marker ;
...
typedef struct s_AIFFMarker AIFF_MarkerChunk ;
...
typedef struct s_AIFFLoop AIFF_AIFFLoop ;
...
typedef struct s_Comment AIFF_Comment ;
