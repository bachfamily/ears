...
t_ears_err ears_buffer_rubberband(t_object *ob, t_buffer_obj *source, t_buffer_obj *dest, t_llll *timestretch_factor, t_llll *pitchshift_factor, RubberBand::RubberBandStretcher::Options options, long blocksize_samps, e_slope_mapping slopemapping);
